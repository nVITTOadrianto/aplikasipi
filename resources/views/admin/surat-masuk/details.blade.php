    ...
    <main class="container py-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p class="card-text"><strong>Tanggal Diterima:</strong> {{ $suratMasuk->tanggal_diterima ? $suratMasuk->tanggal_diterima : 'Belum Diterima' }}</p>
                ...
                @if ($suratMasuk->file_surat)
                    <p class="card-text"><strong>File Surat:</strong> <a href="{{ asset('storage/uploads/surat_masuk/' . $suratMasuk->file_surat) }}" target="_blank">Lihat File</a></p>
                @endif
            </div>
