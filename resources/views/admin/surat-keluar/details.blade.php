...
@section('content')
    <main class="container py-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="card-title mb-3">Surat Kepada: {{ $suratKeluar->pengirim }}</h5>
                ...
                @if ($suratKeluar->file_surat)
                    <p class="card-text"><strong>File Surat:</strong> <a href="{{ asset('storage/uploads/surat_keluar/' . $suratKeluar->file_surat) }}" target="_blank">Lihat File</a></p>
                @endif
            </div>
