...
@section('content')
    <main class="container py-4">
        ...
        @endif
        <form action="{{ route('subkeg-lain.surat-keluar.update', $suratKeluar->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <a href="{{ route('subkeg-lain.surat-keluar.index') }}" class="btn btn-secondary">Kembali</a>
        </form>
    </main>
@endsection
