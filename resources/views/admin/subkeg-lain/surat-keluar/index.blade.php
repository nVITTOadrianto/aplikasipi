...
@section('content')
    <main class="container py-4">
        ...
        @endsession
        <div class="mb-3">
            <a href="{{ route('subkeg-lain.surat-keluar.create') }}" class="btn btn-success">
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="d-flex gap-1">
                                <a href="{{ route('subkeg-lain.surat-keluar.show', $surat->id) }}" class="btn btn-info btn-sm">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('subkeg-lain.surat-keluar.edit', $surat->id) }}" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('subkeg-lain.surat-keluar.destroy', $surat->id) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
