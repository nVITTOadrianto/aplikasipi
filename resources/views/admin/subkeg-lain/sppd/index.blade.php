...
@section('content')
    <main class="container py-4">
        ...
        @endsession
        <div class="mb-3">
            <a href="{{ route('subkeg-lain.sppd.create') }}" class="btn btn-success">
                <i class="bi bi-plus-circle"></i> Buat Surat Baru
            </a>
        </div>
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('subkeg-lain.sppd.index') }}" method="GET">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <div class="mb-3">
                                ...
                                <a href="{{ route('subkeg-lain.sppd.index') }}" class="btn btn-secondary">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="d-flex gap-1">
                                <a href="{{ route('subkeg-lain.sppd.show', $surat->id) }}" target="_blank" class="btn btn-info btn-sm">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('subkeg-lain.sppd.edit', $surat->id) }}" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('subkeg-lain.sppd.destroy', $surat->id) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
